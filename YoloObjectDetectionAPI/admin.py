...
from .models import ImageUpload, Detections, Order
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'order_name', 'user', 'material', 'created_at')  # Отображаемые поля
    search_fields = ('order_name', 'user__username')  # Поиск по названию и пользователю
    list_filter = ('material', 'created_at')  # Фильтрация
